...
<!--
	...
	div.debug, div.debug div.debugcollapse{
		display: none; 
	}
	div.debug table{
...
%>
		<tr>
			...
			<td>
				<%
				if(isCollapse) {
					out.println("<a href='javascript:void(0)' class='debugcollapse'>&gt;&gt;&gt;</a><div class='debugcollapse'>"+value+"</div>");
				} else {
					out.println(value);
				}
				%>
...
if(div.addEventListener) {
	div.addEventListener('click', function(e){
		if(e.target.className=='debugcollapse') {
