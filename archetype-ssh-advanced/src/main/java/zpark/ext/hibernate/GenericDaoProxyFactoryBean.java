...
//    }
    ...
    public GenericDaoProxyFactoryBean(Class<?> objectClass, SessionFactory sessionFactory) {
        this.objectClass = objectClass;
    ...
    public final class GenericDaoMethodInterceptor implements org.aopalliance.intercept.MethodInterceptor {
        private final SessionFactoryGenericDao<?, ?> target;

        public GenericDaoMethodInterceptor(SessionFactoryGenericDao<?, ?> target) {
            this.target = target;
        }
        ...
        public Object invoke(MethodInvocation mi) throws Throwable {
            ...
            if (q != null) {
                if (zpark.ext.query.Page.class.equals(m.getReturnType())) {
                    ...
                    return target.findPage(info.no, info.size, info.hql.toString(), info.counthql.toString(),
                            info.params);
    ...
    public Object getObject() throws Exception {
        ...
        final SessionFactoryGenericDao<?, ?> target = new SessionFactoryGenericDao(cls[0], cls[1], sessionFactory);
